...
<body>
	...
	<div class="wrapper">
		<h1 class="title">Renovación</h1>
		<form action="">
				<div class="credenciales">
					<a class="btnLogin"  href="">Compatibilidad</a>
					<a class="btnLogin" href="">Notificacion</a>
					<a class="btnLogin" href="">Inspeccion</a>
					<a class="btnLogin" href="">Inspeccion 2</a>
				</div>
			</form>
	</div>
</body>
